...
\usepackage[left=12.41cm,right=12.41cm,bottom=7.5cm,top=7.5cm,landscape]{geometry}
\usepackage{multicol}
\usepackage{verbatim}
\usepackage{float}
\usepackage{graphicx}
...
\section{LOL}
Bert was told at work that men can stay longer when they have sex if they masturebate a moment before.
So he wanted to try. But where?

Not in the office, not at home. Then he came up with something
He parked the car on the way home from work and lay under the car and pretended to check it.
He closed his eyes and took it out and began to masturebatewhen he suddenly heard voices
He didnt care.

Then he heard:

\setlength{\parskip}{0.0em}
-This is the police whats happening here?

-Im just checking the drive shaft says Bert with closed eyes.

-Maybe you should check the brakes too, because your car rolled off five minutes ago.
\setlength{\parskip}{0.8em}
